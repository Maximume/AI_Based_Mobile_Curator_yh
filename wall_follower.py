...
import sys                  #arg deleted
from math import cos, sin   #set range by force
'''
...
#param changed for better drive
linear_vel = 0.3                #init 0.1
angular_vel = 0.7               #init 0.4
wall_distance = 0.8             #init 0.4
wall_distance_forward = 0.7     #init 0.30
wall_distance_side = 0.7        #init 0.35
...
def calculate_lasers_range(data):
    #dynamic range intervals doesnt work.
    """
    ...
    laser_sensors['n']  = np.mean(np.setdiff1d(data.ranges[:35] + data.ranges[-35:], [0]))
